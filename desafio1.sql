...
CREATE DATABASE IF NOT EXISTS SpotifyClone;
 ...
 CREATE TABLE SpotifyClone.artistas(
   ...
   CREATE TABLE SpotifyClone.albuns_artistas(
   ...
   CREATE TABLE SpotifyClone.cancoes_albuns(
      cancao_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
      album_id INT NOT NULL,
      cancao VARCHAR(50) NOT NULL,
      duracao_segundos INT,
      FOREIGN KEY(album_id) REFERENCES albuns_artistas (album_id)
  ) engine = InnoDB;
   ...
   FOREIGN KEY(usuario_id) REFERENCES usuarios (usuario_id),
   FOREIGN KEY(cancao_id) REFERENCES cancoes_albuns (cancao_id)
  ) engine = InnoDB;
  ...
  VALUES
    ...
    ('Nina Simone');
      ...
      INSERT INTO SpotifyClone.albuns_artistas (album, artista_id, ano_lancamento)
  VALUES
    ('Renaissance', 1, '2022'),
	('Jazz', 2, '1978'),
    ('Hot Space', 2, '1982'),
    ...
    ('I Put A Spell On You', 6, '2012');
      ...
      INSERT INTO SpotifyClone.cancoes_albuns (album_id, cancao, duracao_segundos )
  VALUES
  (1, 'BREAK MY SOUL', 279),
